...
foreach(_expectedTarget proto gtirb)
...
set_target_properties(proto PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib/libprotobuf.so;-lpthread"
)

# Create imported target gtirb
add_library(gtirb SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/gtirbTargets-*.cmake")
