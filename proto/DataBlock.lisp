...
(cl:defclass data-block (pb:protocol-buffer)
  (
  (uuid
   :accessor uuid
...
(cl:eval-when (:load-toplevel :compile-toplevel :execute)
  (cl:export 'data-block))

(cl:eval-when (:load-toplevel :compile-toplevel :execute)
  (cl:export 'uuid))


(cl:defmethod (cl:setf uuid) :after (x (self data-block))
  (cl:declare (cl:ignore x))
  (cl:setf (cl:ldb (cl:byte 1 0) (cl:slot-value self '%has-bits%)) 1))

(cl:unless (cl:fboundp 'has-uuid)
  (cl:defgeneric has-uuid (proto)))
(cl:defmethod has-uuid ((self data-block))
...
(cl:defmethod clear-uuid ((self data-block))
...
(cl:defmethod (cl:setf size) :after (x (self data-block))
  (cl:declare (cl:ignore x))
  (cl:setf (cl:ldb (cl:byte 1 1) (cl:slot-value self '%has-bits%)) 1))

(cl:unless (cl:fboundp 'has-size)
  (cl:defgeneric has-size (proto)))
(cl:defmethod has-size ((self data-block))
...
(cl:defmethod clear-size ((self data-block))
...
(cl:defmethod cl:print-object ((self data-block) stream)
...
(cl:defmethod pb:clear ((self data-block))
  (cl:when (cl:logbitp 0 (cl:slot-value self '%has-bits%))
    (cl:setf (cl:slot-value self 'uuid) (cl:make-array 0 :element-type '(cl:unsigned-byte 8))))
  (cl:setf (cl:slot-value self 'size) 0)
...
(cl:defmethod pb:is-initialized ((self data-block))
  cl:t)

(cl:defmethod pb:octet-size ((self data-block))
  (cl:let ((size 0))
...
(cl:defmethod pb:serialize ((self data-block) buffer index limit)
...
(cl:defmethod pb:merge-from-array ((self data-block) buffer start limit)
  (cl:declare (cl:type com.google.base:octet-vector buffer)
...
(cl:defmethod pb:merge-from-message ((self data-block) (from data-block))
